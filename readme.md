...
An intelligent web application that helps Thai investors find and manage the perfect mutual funds using AI recommendations, comprehensive analysis tools, and educational resources.

[🌐 Visit Live Demo](https://thai-mf-advisor.onrender.com/) • [📂 Repository](https://github.com/Bright-Kunakorn/thai-mf-advisor)

**Features:**
- 🤖 AI-powered fund recommendations based on risk profile & investment goals
- 📊 Real-time fund comparison & performance analytics
- 💼 Portfolio tracking & management
- 📈 Investment calculator & risk assessment tools
